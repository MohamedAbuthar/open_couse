                ...
                <Card key={index} className="bg-white border border-gray-200 hover:shadow-lg transition-shadow">
                  <CardHeader>
                    <div className="flex items-start justify-between mb-4">
                      <span className={`${event.typeColor} px-3 py-1 rounded-full text-sm font-semibold`}>
                        {event.type}
                      </span>
                      <span className={`${event.statusColor} px-3 py-1 rounded-full text-sm font-semibold`}>
                        {event.status}
                      </span>
                    </div>
                    <CardTitle className="text-xl font-bold mb-4">{event.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
